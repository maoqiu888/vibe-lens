...
3. **结尾自然收束**——最后用中文说结论和分数，例如"值得追，91%"、"看心情吧，55%"、"别浪费时间了，23%"。禁止出现英文字段名（verdict、final_score 等）
4. **引用原文里的具体词句**加你的反应
...
- 叙述结构：禁止"首先...其次...最后..."
- 英文字段名泄露：verdict、final_score、item_profile、reasons 等英文词禁止出现在输出里
...
def _build_user_prompt(
    ...
    return (
        ...
        f"基于以上所有信息，用朋友语气给他建议。结尾用中文自然地说结论和分数（如'值得追，91%'），禁止输出英文字段名。"
    )
